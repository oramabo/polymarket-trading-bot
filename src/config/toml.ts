...
export const ConfigSchema = z.object({
  ...
  trade_2: z.object({
    ...
    trailing_stop_pct: z.number().default(0.25),
    stop_loss_pct: z.number().default(0.40),
    take_profit_ratio: z.number().default(0.90),
    min_signal_strength: z.number().default(0.35),
